...
> Esta página actúa simultáneamente como repositorio de referencia y guía de presentación del workshop.
...
| # | Bloque | Duración |
|---|--------|----------|
| 1 | [¿Qué es Spec-Driven Development?](#-qué-es-spec-driven-development) | 15 min |
| 2 | [El flujo SDD: los 7 pasos](#-el-flujo-sdd-los-7-pasos) | 30 min |
| 3 | [Instalación y configuración](#-instalación-y-configuración) | 10 min |
| 4 | [Demo completa: Payment Processing Microservice](#-demo-completa-payment-processing-microservice) | 40 min |
| 5 | [Ejercicio práctico guiado](#-ejercicio-práctico-guiado) | 30 min |
| 6 | [Extensiones y presets de comunidad](#-extensiones-y-presets-de-comunidad) | 10 min |
| 7 | [Preguntas frecuentes](#-preguntas-frecuentes) | 15 min |
